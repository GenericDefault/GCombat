...
self.expl = {}
	...
	self.val1 = 0
	self.val2 = 0
	RD_AddResource(self.Entity, "Munitions", 24000)
	
	RD_SupplyResource(self.Entity, "Munitions", 24000)
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "massivecrate" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
	return ent
...
act:Remove()
RD_SupplyResource(self.Entity, "Munitions", 5000)
end
...
function ENT:Think()
	...
	RD_SupplyResource(self.Entity, "Munitions", 750)
	return true
end

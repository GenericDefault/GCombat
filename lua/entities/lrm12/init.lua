...
self.Entity:SetModel( "models/props/cs_assault/pylon.mdl" )
--self.Entity:SetAngles(self.flightvector) 	
 ...
 function ENT:Think()
	...
	if self.timeleft < CurTime() then
		brokedshell = ents.Create("prop_physics")
					...
					brokedshell:SetKeyValue( "model", "models/props/cs_assault/pylon.mdl" )
	...
	self.flightvector = self.flightvector + Vector(math.Rand(-0.75,0.75), math.Rand(-0.75,0.75), math.Rand(-0.5,0.5))

...
self.expl = {}
	...
	self.val1 = 0
	self.val2 = 0
	RD_AddResource(self.Entity, "Munitions", 8000)
	
	RD_SupplyResource(self.Entity, "Munitions", 8000)
...
act:Remove()
RD_SupplyResource(self.Entity, "Munitions", 1250)
end
...
function ENT:Think()
	...
	RD_SupplyResource(self.Entity, "Munitions", 350)
	return true
end

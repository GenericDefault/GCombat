...
self.expl = {}
	...
	self.val1 = 0
	self.val2 = 0
	RD_AddResource(self.Entity, "Munitions", 12000)
	
	RD_SupplyResource(self.Entity, "Munitions", 12000)
...
act:Remove()
RD_SupplyResource(self.Entity, "Munitions", 3000)
end

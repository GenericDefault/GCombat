...
self.expl = {}
	...
	self.val1 = 0
	self.val2 = 0
	RD_AddResource(self.Entity, "Munitions", 1000000)
	
	RD_SupplyResource(self.Entity, "Munitions", 40000)
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "bottomlesscrate" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
	return ent
...
function ENT:Think()
	...
	RD_SupplyResource(self.Entity, "Munitions", 10000)
	return true
end

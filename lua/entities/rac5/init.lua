...
function ENT:Initialize()   
	...
	self.Outputs = Wire_CreateOutputs( self.Entity, { "Can Fire" , "Remaining" })
end   
...
function ENT:firewerfer()
	...
	if (self.ammos > 0) then
		...
		local ent = ents.Create( "rac5shell" )
...
function ENT:Think()
	...
	Wire_TriggerOutput(self.Entity, "Remaining", remain)

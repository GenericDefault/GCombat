...
function ENT:Initialize()   
	...
	self.Entity:SetColor(40,40,40,255)
...
function ENT:fireAPshell()
		...
		trace.endpos = self.Entity:GetPos() + self.Entity:GetUp() * 300
		...
		if (tr.Hit && tr.Entity:IsValid()) then
			if ( !tr.Entity:IsWorld() || !tr.Entity:IsPlayer() || !tr.Entity:IsNPC() || !tr.Entity:IsVehicle()) then
				local damagemod = (physo:GetVelocity():Length() * physo:GetAngleVelocity():Length()) / 300

...
function ENT:Initialize()   
	...
	self.Entity:SetColor(75,175,210,255)
...
function ENT:firewerfer()
	...
	if (self.ammos > 0) then
		...
		local ent = ents.Create( "uac5shell" )
...
function ENT:Think()
	...
	Wire_TriggerOutput(self.Entity, "Bombardments Remaining", remain)
